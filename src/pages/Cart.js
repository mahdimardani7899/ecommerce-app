      ...
      return (
        <div className="my-6">
          {data.map(({ product, count }, index) => {
            return (
              <div
                className="border grid grid-cols-12 md:grid-cols-11 items-center gap-2 my-5 shadow text-xs font-normal md:text-base md:font-bold scale-100 hover:scale-125 ease-in duration-300"
                key={product._id}
              >
                <div
