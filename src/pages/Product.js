...
import { addProductTocartLS, getOneProduct, AddTocartLS, minusTocartLS, removeFromcartLS, exitUser } from "../redux/action";
      ...
      return (
        <div className="my-6 grid grid-cols-1 md:grid-cols-2 border p-3 items-center">
          <div>
            ...
            src={data[0]?.image}
            alt={data[0]?.name}
            className="shadow-lg scale-75 hover:scale-100 ease-in duration-500"
            />
            </div>
